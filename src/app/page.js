...
export default function Home() {
  return (
    <div className='bg-white dark:bg-black  flex min-h-screen justify-center items-center '>
      <main className='flex min-h-screen justify-center items-center w-full max-w-3xl flex-col items-center gap-y-8 py-32 px-16 bg-white dark:bg-black '>
        <Link href='/gallery'>
          <div className='text-center'>
            ...
            <h1 className='text-(--color-white) font-bold'>View Gallery Page</h1>
          </div>
        </Link>
      </main>
    </div>
